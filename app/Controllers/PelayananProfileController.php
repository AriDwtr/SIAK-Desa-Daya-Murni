...
class PelayananProfileController extends BaseController
{
    private $db;
    ...
    public function index()
    {
        ...
        return view('pelayanan/profile/profile', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->route('pelayanan.profile');
        }else{
            $data = [
                'id_pegawai' => $session->get('id_pegawai'),
                'nip' => $session->get('nip'),
    ...
    public function photo()
    {
        ...
        return view('pelayanan/profile/photo', $data);
    }
    ...
    public function photoupload($id)
    {
        ...
        return redirect()->route('pelayanan.logout');
        }else{
            $data = [
                'id_pegawai' => $session->get('id_pegawai'),
                'nip' => $session->get('nip'),
