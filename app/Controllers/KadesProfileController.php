...
class KadesProfileController extends BaseController
{
    private $db;
    ...
    public function index()
    {
        ...
        return view('kades/profile/profile', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->route('kades.profile');
        }else{
            $data = [
                'id_pegawai' => $session->get('id_pegawai'),
                'nip' => $session->get('nip'),
    ...
    public function photo()
    {
        ...
        return view('kades/profile/photo', $data);
    }
    ...
    public function photoupload($id)
    {
        ...
        return redirect()->route('kades.logout');
        }else{
            $data = [
                'id_pegawai' => $session->get('id_pegawai'),
                'nip' => $session->get('nip'),
