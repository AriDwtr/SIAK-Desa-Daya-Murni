...
<section class="content">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title">Form Surat ket. Tidak Mampu</h3>
        </div>
        <div class="card-body">
            <form action="<?= route_to('pelayanan.tidakmampu.store') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary w-100"><i class="fas fa-copy"></i> Buat Surat ket. Tidak Mampu</button>
                </div>
            </form>
        </div>
        <!-- /.card-body -->
