...
<body>
  ...
  <center>
    <p style="margin:0;"><b><u>SURAT KETERANGAN TIDAK MAMPU</u></b></p>
  </center>
  <center>
  <?php foreach ($sk as $sk) : ?>
    <p style="margin:0;">Nomor : 03.0<?= $sk->tidak_mampu + 1 ?>/DM-TM/<?=$bul?>/<?=$tahun?></p>
    <?php endforeach ?>
  </center>
  <div id=halaman>
    <p>Yang bertanda tangan dibawah ini Kepala Desa Daya Murni menerangkan bahwa :</p>
    <table style="margin-left:20;">
      <?php foreach ($tidakmampu as $index => $data) : ?>
        <tr>
    ...
    <p align="justify" style="line-height: 30px;">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang dengan identitas yang telah disebutkan di atas benar-benar 
      penduduk yang terdaftar di Desa Daya Murni Kecamatan Muara Sugihan Kabupaten
      Banyuasin Provinsi Sumatera Selatan. Berdasarkan keadaan serta fakta yang ada, benar bahwa orang yang bersangkutan termasuk dalam Golongan <b>keluarga kurang mampu</b>.
    </p>
    <p align="justify" style="line-height: 30px;">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian Surat Keterangan Tidak Mampu ini kami buat 
