...
<section class="content">
    ...
    <div class="card card-secondary">
        <div class="card-body">
            <form action="<?= route_to('pelayanan.penduduk.anak.store') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary w-100"><i class="fas fa-user-plus"></i> Tambahkan Data Anak</button>
                </div>
            </form>
        </div>
        <!-- /.card-body -->
