...
<body>
  ...
  <center>
    <p style="margin:0;"><b><u>SURAT KETERANGAN PINDAH DATANG</u></b></p>
  </center>
  <center>
  <?php foreach ($sk as $sk) : ?>
    <p style="margin:0;">Nomor : 04.0<?= $sk->pindah_datang + 1 ?>/DM-PD/<?=$bul?>/<?=$tahun?></p>
    <?php endforeach ?>
  </center>
  <div id=halaman>
    <p>Yang bertanda tangan dibawah ini Kepala Desa Daya Murni menerangkan bahwa :</p>
    <table style="margin-left:20;">
      <?php foreach ($pindahdatang as $index => $data) : ?>
        <tr>
        ...
        <tr>
          ...
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><?= ucwords($data->alamat_sekarang) ?></td>
        </tr>
        <tr>
          <td style="width: 30%;">Alamat Tujuan</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><?= ucwords($data->alamat_tujuan) ?></td>
        </tr>
      <?php endforeach ?>
    </table>
