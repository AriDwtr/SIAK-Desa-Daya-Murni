...
<section class="content">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title">Form Surat Ket. Kematian</h3>
        </div>
        <div class="card-body">
            <form action="<?= route_to('pelayanan.kematian.store') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="alamat" rows="3" placeholder="Alamat Tinggal"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Tanggal Wafat</label>
                        <input type="date" name="tanggal_wafat" value="<?= old('tanggal_wafat'); ?>" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Lokasi Pemakaman</label>
                        <input type="text" name="pemakaman" value="<?= old('pemakaman'); ?>" class="form-control" placeholder="Lokasi Pemakaman">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary w-100"><i class="fas fa-copy"></i> Buat Surat Ket Kematian</button>
                </div>
            </form>
        </div>
        <!-- /.card-body -->
