...
<body>
  ...
  <center>
    <p style="margin:0;"><b><u>SURAT KETERANGAN KELAHIRAN</u></b></p>
  </center>
  <center>
  <?php foreach ($sk as $sk) : ?>
    <p style="margin:0;">Nomor : 04.0<?= $sk->kelahiran + 1 ?>/DM-KL/<?=$bul?>/<?=$tahun?></p>
    <?php endforeach ?>
  </center>
  <div id=halaman>
    <p>Yang bertanda tangan dibawah ini Kepala Desa Daya Murni menerangkan bahwa :</p>
    <table style="margin-left:20;">
      <?php foreach ($kelahiran as $index => $data) : ?>
        <tr>
          <td style="width: 30%;">NAMA</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><b><?= ucwords($data->nama_anak) ?></b></td>
        </tr>
        <tr>
          <td style="width: 30%;">Tempat, tanggal lahir</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><?= ucwords($data->	tempat_lahir_anak) . ', ' . date('j F Y', strtotime($data->tgl_lahir_anak)) ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="width: 65%;"><?= $data->agama_anak ?></td>
        </tr>
        <tr>
          <td style="width: 30%; vertical-align: top;">Alamat Lahir</td>
          <td style="width: 5%; vertical-align: top;">:</td>
          <td style="width: 65%;"><?= ucwords($data->lokasi_lahir) ?></td>
        </tr>
      <?php endforeach ?>
    </table>
    <p align="justify" style="line-height: 30px;">
    Pihak yang diterangkan diatas adalah anak kandung dari :
    </p>
    <table style="margin-left:20;">
      <?php foreach ($kelahiran as $index => $data) : ?>
        <tr>
          ...
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><b><?= $data->nik_ayah ?></b></td>
        </tr>
        <tr>
          <td style="width: 30%;">NAMA AYAH</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><b><?= ucwords($data->nama_ayah) ?></b></td>
        </tr>
        <tr>
          <td style="width: 30%;">Tempat, tanggal lahir</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><?= ucwords($data->	tempat_lahir_ayah) . ', ' . date('j F Y', strtotime($data->tgl_lahir_ayah)) ?></td>
        </tr>
        <hr>
        <tr>
          <td style="width: 30%;">NIK IBU</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><b><?= $data->nik_ibu ?></b></td>
        </tr>
        <tr>
          <td style="width: 30%;">NAMA IBU</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><b><?= ucwords($data->nama_ibu) ?></b></td>
        </tr>
        <tr>
          <td style="width: 30%;">Tempat, tanggal lahir</td>
          <td style="width: 5%;">:</td>
          <td style="width: 65%;"><?= ucwords($data->tempat_lahir_ibu) . ', ' . date('j F Y', strtotime($data->tgl_lahir_ibu)) ?></td>
        </tr>
      <?php endforeach ?>
    </table>
    <p align="justify" style="line-height: 30px;">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian Surat Keterangan Kelahiran ini kami buat 
