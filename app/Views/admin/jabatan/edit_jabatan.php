...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <form action="<?= route_to('admin.jabatan.update', $edit_jabatan['id_jabatan']) ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" name="jabatan" value="<?= $edit_jabatan['jabatan'] ?>" class="form-control" id="exampleInputEmail1" placeholder="Masukan Jabatan">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <select class="form-control" name="role">
                                <option value="pelayanan" <?= $edit_jabatan['status']=='Pelayanan' ? 'selected': '' ?>>Pelayanan</option>
                                <option value="admin" <?= $edit_jabatan['status']=='Admin' ? 'selected': '' ?>>Administrator</option>
                                <option value="kades" <?= $edit_jabatan['status']=='Kades' ? 'selected': '' ?>>Kepala Desa</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-building"></i>  Perbaharui Data</button>
                            </div>
                        </div>
                    </div>
